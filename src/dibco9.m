...
mp=mean(mpm(:));
f=figure;
data={'OTSU',78.72,15.34,5.77,13.3;'SAUV',85.41,16.39,6.94,3.2;'NIBL',55.82,9.89,16.4,61.5;'BERN',52.48,8.89,14.29,113.8;'GATO',85.25,16.5,10,0.7;'PROPOSED',avgf,psn,nr,mp};
